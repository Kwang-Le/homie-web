<template>
  <div class="admin-ch-nh-s-a-t-i-kho-n">
    <div class="rectangle-30"></div>
    <div class="ch-nh-s-a-t-i-kho-n-id-1">Chỉnh sửa tài khoản ID 1</div>
    <div class="group-n-btn">
      <div class="rectangle-23"></div>
      <div class="c-p-nh-t">Cập nhật</div>
    </div>
    <div class="text-field">
      <div class="text-field2">
        <div class="frame">
          ...
          <div class="frame3">
            <div class="xxxxxxxxx">xxxxxxxxx</div>
          </div>
        </div>
      </div>
    </div>
    <div class="text-field3">
      <div class="text-field2">
        <div class="frame">
          <div class="frame2"></div>
          <div class="frame3">
            <div class="ho-ng-h-i-n">Hoàng Hải Nữ</div>
          </div>
        </div>
      </div>
    </div>
    <div class="ng-i-d-ng">Người dùng</div>
    <div class="ch">Chế độ</div>
    <div class="m-t-kh-u">Mật khẩu</div>
    <div class="ch-c-n-ng">Chức năng</div>
    <svg
      class="icon-x-letter"
      width="40"
      height="40"
    ...
    >
      <g filter="url(#filter0_d_975_7735)">
        <path
      ...
      <defs>
        ...
        >
          ...
          <feBlend
            ...
            result="effect1_dropShadow_975_7735"
          />
          <feBlend
            mode="normal"
            in="SourceGraphic"
            in2="effect1_dropShadow_975_7735"
            result="shape"
          />
        </filter>
      </defs>
    ...
    <div class="filter-radio-type">
      <div class="radio-button-select">
        ...
        <div class="k-ch-ho-t">Kích hoạt</div>
      </div>
      <div class="radio-button-not-select">
        <div class="t-t">Tắt</div>
      </div>
    </div>
    <div class="filter-dropdown-type">
      <div class="dropdown">
        <div class="frame4">
          <div class="frame2"></div>
          <div class="frame5">
            <div class="t-nguy-n">Chức năng</div>
            <svg
            ...
            >
              <path
                d="M7.82373 10.8594L13.3714 16.407L18.9191 10.8594H7.82373Z"
                fill="#666666"
              />
            </svg>
          </div>
